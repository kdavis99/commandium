...
var commandium = (function(){
   var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,4],$V1=[1,5],$V2=[1,6],$V3=[1,7],$V4=[5,7,10,11,13];
   var parser = {trace: function trace() { },
      yy: {},
    symbols_: {"error":2,"input":3,"commands":4,"EOF":5,"command":6,"T_CP":7,"T_NUM":8,"T_SEMIC":9,"T_RM":10,"T_ACT":11,"T_STRING_CONST":12,"T_ACTIVE":13,"$accept":0,"$end":1},
    terminals_: {2:"error",5:"EOF",7:"T_CP",8:"T_NUM",9:"T_SEMIC",10:"T_RM",11:"T_ACT",12:"T_STRING_CONST",13:"T_ACTIVE"},
    productions_: [0,[3,2],[4,2],[4,1],[6,3],[6,3],[6,3],[6,3],[6,3],[6,3]],
    ...
    table: [{3:1,4:2,6:3,7:$V0,10:$V1,11:$V2,13:$V3},{1:[3]},{5:[1,8],6:9,7:$V0,10:$V1,11:$V2,13:$V3},o($V4,[2,3]),{8:[1,10],12:[1,11]},{8:[1,12],12:[1,13]},{8:[1,14]},{12:[1,15]},{1:[2,1]},o($V4,[2,2]),{9:[1,16]},{9:[1,17]},{9:[1,18]},{9:[1,19]},{9:[1,20]},{9:[1,21]},o($V4,[2,4]),o($V4,[2,7]),o($V4,[2,5]),o($V4,[2,8]),o($V4,[2,6]),o($V4,[2,9])],
...
var lexer = (function(){
   var lexer = ({
      ...
      EOF:1,
       ...
       rules: [/^(?:\s+)/,/^(?:"[^"]*")/,/^(?:[0-9]+(\.[0-9]+)?\b)/,/^(?:cp\b)/,/^(?:rm\b)/,/^(?:act\b)/,/^(?:;)/,/^(?:$)/,/^(?:.)/],
